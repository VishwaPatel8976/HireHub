    ...
    <div className="sidebarContainer 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8 ">
      ...
      <div className="w-full lg:w-1/4  rounded-2xl shadow-xl px-4 ">
        ...
        <button
          ...
          className="px-6 py-2 text-xl bg-blue-500 mb-5 text-white rounded hover:bg-blue-600 transition duration-300 ease-in-out lg:hidden "
        >
      ...
      <section className="w-full lg:w-3/4 px-4 text-gray-800 max-lg:px-4">
        ...
        {filteredJobs.length > 0 && (
          ...
          text-gray-600 rounded hover:bg-gray-100"
              >
                Previous
              </button>
            </a>
              ...
              (_, index) => (
                <a key={index} href="#job-list">
                  <button
                    ...
                    className={`w-10 h-10 flex items-center justify-center border border-gray-300 px-4 py-2
             text-gray-600 rounded hover:bg-gray-100 ${
               index + 1 === currentPage
            ...
            <a href="#job-list">
              <button
                ...
                className="border border-gray-300 px-4 py-2 text-gray-600 rounded hover:bg-gray-100"
              >
                Next
              </button>
            </a>
